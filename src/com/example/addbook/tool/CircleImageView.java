...
public class CircleImageView extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		/*
		 * Parameters: config The desired config for the resulting bitmap
		 * isMutable True if the resulting bitmap should be mutable (i.e. its
	...
	public Bitmap getCroppedRoundBitmap (Bitmap bitmap,int radius) {
		...
		//为了防止宽高不相等，造成图形图片变形，因此截取长方形中处于中间位置最大的正方形图片
